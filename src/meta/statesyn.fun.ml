...
module StateSyn(StateSyn__0: sig
  ...
  struct
    ...
    (*     | {{D}} O              *);;
    (*     | O1 ^ O2              *);;
    type info_ = | Splits of int 
                 | Rl 
                 | RLdone ;;
    type tag_ = | Parameter of FunSyn.label option 
                | Lemma of info_ 
                | None ;;
    type state_ =
      | State of
        ...
        (int * FunSyn.for_)
        list *
        (FunSyn.for_(* History of residual lemmas *)(* Current Order *)(* length of meta context            *)(* Induction hypothesis, order       *)(* Status information *)(* Context of Hypothesis in general not named *)(* Part of theorem                   *))
        ;;
      ...
      struct
        ...
        and convOrders =
          function 
                   | ([], []) -> true
                   | ((o1_ :: l1_), (o2_ :: l2_))
                       -> (convOrder (o1_, o2_)) && (convOrders (l1_, l2_));;
