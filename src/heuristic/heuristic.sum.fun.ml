...
module Heuristic : HEURISTIC = struct
  ...
  open! struct
    ...
    let rec sum = function
      | { sd = k1; ind = None; c = c1; m = m1; r = r1; p = p1 } -> begin
          if c1 = 0 then
            sqr (Real.fromInt k1) + (5.0 - ratio (c1, m1)) + Real.fromInt r1
          else sqr (Real.fromInt k1) + (1.0 - ratio (c1, m1)) + Real.fromInt r1
        end
      | { sd = k1; ind = Some 0; c = c1; m = m1; r = r1; p = p1 } -> begin
          if c1 = 0 then
            sqr (Real.fromInt k1) + (5.0 - ratio (c1, m1)) + Real.fromInt r1
          else
            sqr (Real.fromInt k1)
      ...
      | { sd = k1; ind = Some i1; c = c1; m = m1; r = r1; p = p1 } -> begin
          if c1 = 0 then
            sqr (Real.fromInt k1) + (5.0 - ratio (c1, m1)) + Real.fromInt r1
          else
            sqr (Real.fromInt k1)
    ...
    let rec conv = function
      | { sd = k1; ind = i; c = c1; m = m1; r = 1; p = p1 } ->
          { sd = k1; ind = i; c = c1; m = m1; r = 1; p = p1 }
      | { sd = k1; ind = i; c = c1; m = m1; r = 0; p = p1 } ->
    ...
    let rec indexToString = function
      | { sd = s1; ind = None; c = c1; m = m1; r = 0; p = p1 } ->
      ...
      | { sd = s1; ind = Some idx; c = c1; m = m1; r = 0; p = p1 } ->
          let i =
            begin if idx = 0 then 0.0 else ratio (1, idx)
            end
          in
          (((((((((((((((((((("(sd * r =" ^ Int.toString (s1 * 3)) ^ ", sd=")
                           ^ Int.toString s1)
           ...
           ^ " sum = ")
          ^ realFmt
              (sum { sd = s1; ind = Some idx; c = c1; m = m1; r = 2; p = p1 }))
          ^ ")"
      | { sd = s1; ind = Some idx; c = c1; m = m1; r = 1; p = p1 } ->
          ...
          (((((((((((((((((((("(sd * r =" ^ Int.toString (s1 * 1)) ^ ", sd=")
           ...
           ^ " sum = ")
          ^ realFmt
              (sum { sd = s1; ind = Some idx; c = c1; m = m1; r = 1; p = p1 }))
          ^ ")"
  end
