...
module type LAYOUT = sig
       ...
       *)
                     ...
                     val
                       namedRecord : (string * (string * layout) list) ->
                                     layout
...
*)
                     ...
                     val
                       recordex : string -> (string * layout) list -> layout
