...
module type SYNTAX = sig
                     ...
                     and sub =
                       ...
                       | Shift of int 
                       | Comp of sub * sub 
                     type nonrec __0 = { id: const ; name: string ;
                       exp: exp ; uni: uni }
                     type nonrec decl = __0
                     type nonrec __1 = { id: const ; name: string ;
                       exp: exp ; def: exp ; height: int ; root: const ;
                       uni: uni }
                     type nonrec def = __1
                     type nonrec __2 = { id: const ; name: string ;
                       exp: exp ; def: exp ; uni: uni }
                     type nonrec abbrev = __2
                     type dec =
                       | Decl of decl 
                       | Def of def 
                       | Abbrev of abbrev 
