...
module type HEURISTIC = sig
                        type nonrec __0 = { sd: int ; ind: int option ;
                          c: int ; m: int ; r: int ; p: int }
      ...
      struct
        let rec compare =
          function 
                   ...
                   | ({ sd = k1; ind = None; c = c1; m = m1; r = r1; p = p1},
                      { sd = k2; ind = Some i2; c = c2; m = m2; r = r2;
                       p = p2})
                       -> begin
                          match Int.compare (c1 * m2, c2 * m1)
                          with 
                   ...
                   | ({ sd = k1; ind = Some i1; c = c1; m = m1; r = r1;
                      ...
                      { sd = k2; ind = Some i2; c = c2; m = m2; r = r2;
                       ...
                       -> begin
                          ...
                          with 
                               | (Equal, Equal, Equal, Equal, result)
                                   -> result
        ...
        let rec sum =
          function 
                   | { sd = k1; ind = None; c = c1; m = m1; r = r1; p = p1}
                       -> realFmt
                          (((Real.fromInt k1) + (ratio (m1, c1))) +
                             (Real.fromInt r1))
                   | { sd = k1; ind = Some i1; c = c1; m = m1; r = r1;
                      p = p1}
                       -> realFmt
                          ((((Real.fromInt k1) + (ratio (1, i1))) +
                              (ratio (m1, c1)))
                             + (Real.fromInt r1));;
          ...
          function 
                   | { sd = s1; ind = None; c = c1; m = m1; r = r1; p = p1}
                       -> ((((((((((((("(c/m=" ^ (Int.toString c1)) ^ "/") ^
                            ...
                            ^ " )"
                   | { sd = s1; ind = Some idx; c = c1; m = m1; r = r1;
                      p = p1}
                       -> ((((((((((((((("(c/m=" ^ (Int.toString c1)) ^ "/")
                                         ^ (Int.toString m1))
                                        ^ "=")
