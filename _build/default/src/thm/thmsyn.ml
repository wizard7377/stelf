          ...
          let rec theoremToConDec' =
            function 
                     ...
                     | (I.Decl (g_, d_), v_) -> begin
                         ...
                         error (r, "Free variables in theorem declaration")
                         end
            in (gBs_,
                (I.ConDec
                 (name, None, i, I.normal_,
                  theoremToConDec' (g_, (I.Uni I.type_)), I.kind_)));;
          ...
          let rec theoremToModeSpine' =
            function 
                     ...
                     | (I.Decl (g_, I.Dec (x, _)), I.Decl (mg_, m), mS)
                         -> theoremToModeSpine'
                            (g_, mg_, (M.Mapp ((M.Marg (m, x)), mS)))
            in theoremToModeSpine' (g_, mg_, M.Mnil);;
        end;;
