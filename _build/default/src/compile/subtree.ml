...
module type SUBTREE = sig
                      ...
                      type typeLabel = | TypeLabel 
                                       | Body 
                      type nonrec normalSubsts = (typeLabel * IntSyn.exp_)
                        RBSet.ordSet
                      ...
                      type cnstr_ =
                        | Eqn of
                          IntSyn.dec_ IntSyn.ctx_ * IntSyn.exp_ * IntSyn.exp_ 
                      type tree_ =
                        | Leaf of
                          normalSubsts * IntSyn.dec_ IntSyn.ctx_ * cGoal_ 
                      ...
                      val
                        matchSig : (IntSyn.cid *
                                    ...
                                    IntSyn.ctx_ *
                                    IntSyn.eclo *
                                    (((CompSyn.conjunction_ * IntSyn.sub_) *
                                      IntSyn.cid) ->
                                     unit)) ->
                                   unit
                      end;;
