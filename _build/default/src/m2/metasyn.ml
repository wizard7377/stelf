...
module type METASYN = sig
                      ...
                      type prefix_ =
                        | Prefix of
                          ...
                          IntSyn.ctx_ *
                          (int
                           IntSyn.ctx_(* Mtx modes                  *)(* G   declarations           *))
                      ...
                      (*      | c:V, IS             *)
                      val
                        createAtomConst : (IntSyn.dctx * IntSyn.head_) ->
                                          IntSyn.exp_ * IntSyn.eclo
                      val
                        createAtomBVar : (IntSyn.dctx * int) ->
                                         IntSyn.exp_ * IntSyn.eclo
                      end;;
(* signature METASYN *);;
...
(* Meta syntax *);;
(* Author: Carsten Schuermann *);;
module MetaSyn(MetaSyn__0: sig module Whnf : WHNF end) : METASYN =
  struct
    (*! structure IntSyn = IntSyn' !*);;
