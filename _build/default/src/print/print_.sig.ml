...
module type PRINT = sig
                    ...
                    val
                      formatDec : (IntSyn.dctx * IntSyn.dec_) ->
                                  Formatter.format
                    val
                      formatDecList : (IntSyn.dctx * IntSyn.dec_ list) ->
                                      Formatter.format
                    val
                      formatDecList' : (IntSyn.dctx *
                                        (IntSyn.dec_ list * IntSyn.sub_)) ->
                                       Formatter.format
                    val
                      formatExp : (IntSyn.dctx * IntSyn.exp_) ->
                                  Formatter.format
                    val
                      formatSpine : (IntSyn.dctx * IntSyn.spine_) ->
                                    Formatter.format
                                    list
                    ...
                    val
                      formatCtx : (IntSyn.dctx * IntSyn.dctx) ->
                                  Formatter.format
                    ...
                    val
                      evarInstToString : (IntSyn.exp_ * string)
                                         list ->
                                         string
                    val
                      evarCnstrsToStringOpt : (IntSyn.exp_ * string)
                                              list ->
                                              string
                                              option
